...
public class SmithingBehaviour extends BeltProcessingBehaviour {
	...
	public interface SmithingBehaviourSpecifics {
	...
	public <T extends SmartBlockEntity & SmithingBehaviourSpecifics> SmithingBehaviour(T be) {
		super(be);
		this.specifics = be;
		entityScanCooldown = ENTITY_SCAN;
		whenItemEnters((s, i) -> SmithingCallbacks.onItemReceived(s, i, this));
		whileItemHeld((s, i) -> SmithingCallbacks.whenItemHeld(s, i, this));
	}
	...
	public float getRenderedHeadOffset(float partialTicks) {
		...
		float ticks = Mth.lerp(partialTicks*2, prevRunningTicks, runningTicks);
